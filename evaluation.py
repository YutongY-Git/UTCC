...
DATA_DIRECTORY = r'E:\2025\A-CY5'
# DATA_LIST_PATH = r'E:\UTB-finish\UTB_master\Train_dataset\test_list.txt'
DATA_LIST_PATH = r'E:\2025\A-CY5\test.txt'
NUM_CLASSES = 2 #

RESTORE_FROM = r'E:\UTB-finish\UTB_master\checkpoints\semi_res101deeplabv3plus\VOC_60000 -q.pth'
# RESTORE_FROM = r'E:\UTB-finish\UTB_master\checkpoints\semi_res101deeplabv3plus\11436-1450 60000.pth'
SAVE_DIRECTORY = r'E:\2025\A-CY5\tree results'
...
def main():
    ...
    for index, batch in enumerate(testloader):
        ...
        size = size[0]
        with torch.no_grad():
             output,_,N = model(Variable(image).cuda()) # model test
